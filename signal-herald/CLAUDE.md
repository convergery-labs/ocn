...
Runs on **port 8006**. Scheduled **Monday, Wednesday, and Thursday at 14:00 UTC** via CloudWatch Events in staging.
...
- CloudWatch rule: Monday, Wednesday, and Thursday at 14:00 UTC, runs `python -m src run --force`
